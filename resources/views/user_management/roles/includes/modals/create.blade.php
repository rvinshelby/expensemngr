    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-body">
                ...
                <div class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="create_role_is_admin" name="is_admin">
                    <label class="custom-control-label" for="create_role_is_admin">Is this an Admin Role?</label>
                </div>
        </div>
